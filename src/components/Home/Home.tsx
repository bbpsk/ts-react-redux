...
import { selectMessage } from "../../store/messageSlice";
import "./Home.scss";
    ...
    <div className="homeContainer">
      <div className="welcomeBox mb-5 p-2">
        ...
        <div className="font-monospace">
          A template website showcasing commonly used React patterns, concepts,
          and tools. Bootstraped with Create React App{" "}
        </div>
      </div>
      <div className="row">
        <div className="col-lg-6 col-12 mb-2">
          ...
          <ul className="list-group">
            <li className="list-group-item">
              Configured routes and navigation using React Router
            </li>
            <li className="list-group-item">
              Developed with Typescript and Sass
            </li>
            <li className="list-group-item">
